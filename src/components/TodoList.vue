<template>
  <div class="container-fluid  ">
    ...
    <div class="row mt-5">
       <div class="col-md-4" v-for="data in DataTodo " :key="data.id">
    <div class="card mt-3" >
  ...
  <div class="modal-dialog" role="document">
    ...
    <input type="text" class="form-control" id="titleTodo" placeholder="Title " v-model="titleEdit">
    <label for="name " class="mt-3">Body</label>
     <input type="text" class="form-control " id="bodyTodo" placeholder="Desc " v-model="bodyEdit">
     <small :class="{'text-danger': bodyEdit.length > max}">{{ bodyEdit.length }}/{{ max }} karakter</small>
    ...
    <loading
      ...
      <hr/>
 <a href="https://www.instagram.com/luizadaaam/" > <span style="color:black"><p>© 2020 - By Luiz Adam Rifaldi</p></span></a>
</div> -->
  </div>
</template>
<script>
